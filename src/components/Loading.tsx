        ...
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overscroll-none bg-white">
            <div className="mb-6 flex h-16 w-16 items-center justify-center">
                <AnimatePresence mode="wait">
                    <motion.div key={currentIcon} initial={{ y: 20, opacity: 0, scale: 0.8 }} animate={{ y: 0, opacity: 1, scale: 1 }} exit={{ y: -20, opacity: 0, scale: 0.8 }} transition={{ duration: 0.3, ease: "easeInOut" }}>
